...
.NOTES
    Repository: https://github.com/alimtvnetwork/gitmap-v17
#>
...
function Install-Binary([string]$zipPath, [string]$installDir) {
    ...
    # Match exact names OR versioned patterns like gitmap-v17.54.6-windows-amd64.exe
    $candidateNames = @(
        $BinaryName,
