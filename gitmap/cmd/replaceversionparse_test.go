...
func TestSlugFromRemote(t *testing.T) {
	cases := map[string]string{
		"https://github.com/alimtvnetwork/gitmap-v17.git": "gitmap-v17",
		"https://github.com/alimtvnetwork/gitmap-v17":     "gitmap-v17",
		"git@github.com:alimtvnetwork/gitmap-v17.git":     "gitmap-v17",
		"git@github.com:alimtvnetwork/gitmap-v17":         "gitmap-v17",
		"ssh://git@host.example/foo/bar/gitmap-v17.git":   "gitmap-v17",
		"gitmap-v17":     "gitmap-v17",
		"gitmap-v17.git": "gitmap-v17",
	}
...
// `current` value — historically this test pinned `gitmap-v17` next to
...
// `gitmap-v17` next to a `current=9` argument.
