...
import (
	...
	"github.com/alimtvnetwork/gitmap-v17/gitmap/fixtureversion"
)
...
// adjacent token (`gitmap-v17`) that MUST NOT match `gitmap-v17`.
...
//
// IMPORTANT: this body MUST contain `gitmap-v17` tokens (the rewrite
// target) and a `gitmap-v17` guarded neighbor. A previous global
...
const fixRepoV9ToV12FixtureBody = `// fixture-stamp: name=fixrepo-v9-to-v12 generation=1 min-current=12 for=v9->v12-width-cross sha=42793bb7b23d
module example.com/consumer

require (
	github.com/alimtvnetwork/gitmap-v17 v0.0.0
)

import gm "github.com/alimtvnetwork/gitmap-v17/gitmap/cmd"

// repo URL: https://github.com/alimtvnetwork/gitmap-v17.git
// guarded:  gitmap-v17 must NOT be rewritten by target=9 (v9 is a
...
// `gitmap-v17` must survive untouched when bumping target=9, because
