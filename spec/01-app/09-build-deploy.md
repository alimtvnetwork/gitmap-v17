...
```powershell
$ldflags = "-X 'github.com/alimtvnetwork/gitmap-v17/gitmap/constants.RepoPath=$absRepoRoot'"
...
```
  ...
  ──────────────────────────────────────────────────
  → Runner CWD: D:\wp-work\riseup-asia\gitmap-v17
  → Repo root: D:\wp-work\riseup-asia\gitmap-v17
...
| Repo root | Root of the gitmap-v17 project |
